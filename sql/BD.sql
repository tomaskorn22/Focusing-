USE [master]
GO
/****** Object:  Database [Focusing Empowering Minds]    Script Date: 14/11/2024 13:52:08 ******/
...
GO
/****** Object:  User [alumno]    Script Date: 14/11/2024 13:52:09 ******/
CREATE USER [alumno] FOR LOGIN [alumno] WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  Table [dbo].[Calendario]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Categorias]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Evento]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Foro]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Juegos]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Melodias]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Recordatorio]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Sentimientos]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SentimientosXJuegos]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SentimientosXMelodias]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SentimientosXTips]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SentimientosXUsuarios]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[SentimientosXUsuarios](
	[Id_sentimientosXUsuarios] [int] IDENTITY(1,1) NOT NULL,
	[Id_sentimiento] [int] NULL,
	[Id_usuario] [int] NULL,
 CONSTRAINT [PK_SentimientosXUsuarios] PRIMARY KEY CLUSTERED 
(
	[Id_sentimientosXUsuarios] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[Tips]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuarios]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[SentimientosXUsuarios]  WITH CHECK ADD  CONSTRAINT [FK_SentimientosXUsuarios_Sentimientos] FOREIGN KEY([Id_sentimiento])
REFERENCES [dbo].[Sentimientos] ([Id_sentimiento])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[SentimientosXUsuarios] CHECK CONSTRAINT [FK_SentimientosXUsuarios_Sentimientos]
GO
ALTER TABLE [dbo].[SentimientosXUsuarios]  WITH CHECK ADD  CONSTRAINT [FK_SentimientosXUsuarios_Usuarios] FOREIGN KEY([Id_usuario])
REFERENCES [dbo].[Usuarios] ([Id_usuario])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[SentimientosXUsuarios] CHECK CONSTRAINT [FK_SentimientosXUsuarios_Usuarios]
GO
/****** Object:  StoredProcedure [dbo].[SP_ComprobarUsuarioValido]    Script Date: 14/11/2024 13:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
